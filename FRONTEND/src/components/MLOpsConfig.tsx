  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* Model Selection */}
        <div className="md:col-span-8 glass-card p-8 rounded-xl border border-outline-variant shadow-[0_0_20px_rgba(133,173,255,0.05)]">
              ...
              <label 
                ...
                className={cn(
                  ...
                  selectedModel === model.id 
                    ...
                    : "bg-surface-low border-transparent hover:border-outline-variant"
                )}
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  {selectedModel === model.id ? (
                    ...
                    <div className="w-5 h-5 rounded-full border-2 border-outline-variant group-hover:border-outline-variant" />
                  )}
                </div>
                ...
                <div className="flex gap-2">
                  <span className="text-[9px] px-2 py-0.5 rounded bg-surface-highest text-on-surface-variant border border-outline-variant uppercase tracking-widest font-bold">
                    {model.params}
                  </span>
                  <span className="text-[9px] px-2 py-0.5 rounded bg-surface-highest text-on-surface-variant border border-outline-variant uppercase tracking-widest font-bold">
                    {model.opt}
        ...
        {/* System Prompt */}
        <div className="md:col-span-12 glass-card p-8 rounded-xl border border-outline-variant">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
