  ...
  return (
    ...
    >
      <header className="flex justify-between items-end">
        <div>
          <h2 className="text-4xl font-extrabold font-headline tracking-tight text-on-surface mb-2">Cơ sở tri thức</h2>
          <p className="text-on-surface-variant max-w-2xl">Tích hợp các nguồn dữ liệu nội bộ thông qua việc nạp tài liệu, thu thập dữ liệu web và vector hóa tự động cho quá trình RAG.</p>
        </div>
      </header>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex gap-2 p-1 bg-surface-low rounded-xl self-start border border-outline-variant">
          <button className="px-6 py-2.5 rounded-lg bg-surface-highest text-primary font-semibold text-sm transition-all shadow-sm">Tải lên Tài liệu</button>
          <button className="px-6 py-2.5 rounded-lg text-on-surface-variant hover:text-on-surface font-medium text-sm transition-all">Thu thập Web</button>
          <button className="px-6 py-2.5 rounded-lg text-on-surface-variant hover:text-on-surface font-medium text-sm transition-all">Giám sát</button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            <div className="glass-card p-12 rounded-xl border-dashed border-2 border-outline-variant hover:border-primary/40 transition-all group cursor-pointer flex flex-col items-center justify-center text-center min-h-[400px]">
              ...
              <h3 className="text-2xl font-bold text-on-surface mb-2">Kéo thả Tài liệu</h3>
              <p className="text-on-surface-variant mb-8 max-w-sm">Hỗ trợ các định dạng PDF, DOCX, và TXT. Kích thước tối đa 50MB. Các tệp được mã hóa và phân mảnh tự động.</p>
            ...
            <div className="bg-surface rounded-xl p-6 border border-outline-variant">
              <div className="flex justify-between items-center mb-6">
                <h4 className="font-bold text-lg text-on-surface">Tài liệu vừa nạp</h4>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="bg-surface rounded-xl p-6 border border-outline-variant shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="font-bold text-lg text-on-surface">Thu thập Web</h4>
              </div>
              <div className="space-y-5">
                <div className="space-y-2">
                  <label className="text-[10px] text-on-surface-variant font-bold uppercase tracking-widest">URL Nguồn</label>
                  <input 
                    type="url" 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] text-on-surface-variant font-bold uppercase tracking-widest">Độ sâu Thu thập</label>
                  <select className="w-full bg-surface-high border-none rounded-xl px-4 py-3 text-sm text-on-surface focus:ring-1 focus:ring-secondary appearance-none cursor-pointer">
                    <option>Chỉ một Trang</option>
                    <option>Độ sâu tối đa: 2</option>
                    <option>Độ sâu tối đa: 5</option>
                  </select>
                </div>
                <div className="flex items-center gap-3 py-2">
                  ...
                  <label htmlFor="render" className="text-xs text-on-surface-variant font-medium">Xuất JavaScript (Mô phỏng trình duyệt)</label>
                </div>
            ...
            <div className="bg-surface-low rounded-xl p-6 relative overflow-hidden group border border-outline-variant">
              ...
              <div className="space-y-6 relative z-10">
                <div>
                  ...
                  <p className="text-[10px] text-on-surface-variant uppercase font-bold tracking-widest mt-1">Tổng số Embeddings</p>
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between text-xs font-bold">
                    <span className="text-on-surface-variant">Dung lượng Lưu trữ</span>
            ...
            <div className="flex flex-wrap gap-2">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-surface rounded-full border border-outline-variant">
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest text-on-surface-variant">Đang lập chỉ mục</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 bg-surface rounded-full border border-outline-variant">
                <div className="w-1.5 h-1.5 rounded-full bg-primary"></div>
                <span className="text-[9px] font-bold uppercase tracking-widest text-on-surface-variant">Sẵn sàng với PostgreSQL</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 bg-surface rounded-full border border-outline-variant">
          ...
          {jobs.map((job) => (
            <div key={job.id} className="bg-surface rounded-2xl p-6 border border-outline-variant hover:border-outline-variant transition-all">
              <div className="flex justify-between mb-4">
                <span className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">Tiến trình #{job.id}</span>
